											...
											<body class="layui-layout-body" style="overflow:scroll;">
												...
												<fieldset class="layui-elem-field">
													...
													<div class="layui-field-box">
														...
														<hr>
															...
															<hr>
																<table class="layui-table">
																	...
																	<tbody id="xk_log_body">
																	</tbody>
																</table>
																<div id="xk_log_bar" class="pagination" style="margin-top:20px;"></div>
															</div>
														</fieldset>
														...
														<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5320"></script>
...
function ajaxList(page) {
	...
	$.ajax({
		type : 'get',
		url : "${pageContext.request.contextPath}/student/xk_log/queryList",
		data : {
			"page":page
		},
		success : function(result) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				html+='<td>'+ stuIdVal+'</td>';
				var createTimeVal=setNullToEmpty(rows[i].xkLog.createTime);
				html+='<td>'+ createTimeVal+'</td>';
				html+='<td>';
				html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].xkLog.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
				html+='</td>';
				html+='</tr>';
			}
			if (rows.length == 0) {
...
function del(e){
	if(window.confirm('你确定要删除该选课记录吗')){
		var id = $(e).attr("data-id");
		$.ajax({
			type : 'get',
			url : "${pageContext.request.contextPath}/student/xk_log/del",
			data : {
				"id":id
			},
			success : function(result) {
