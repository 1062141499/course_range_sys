														...
														<div >
															<div class="layui-form-item layui-form-text" id="stuNoParentContent">
																...
																<div class="layui-input-block">
																	<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入学号" id="stuNo" class="layui-input">
																...
																<div class="layui-form-item layui-form-text" id="passwordParentContent">
																	...
																	<div class="layui-form-item layui-form-text" id="realNameParentContent">
																		...
																		<div class="layui-input-block">
																			<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入姓名" id="realName" class="layui-input">
																				<p style="color:gray"></p>
																			</div>
																		</div>
																		...
																		<div class="layui-form-item layui-form-text" id="celPhoneParentContent">
																			...
																			<div class="layui-form-item layui-form-text" id="enterYearParentContent">
																				...
																				<div class="layui-input-block">
																					<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入入学年份(请输入数字)" id="enterYear" class="layui-input">
																						<p style="color:gray"></p>
																					</div>
																				</div>
																				...
																				<div class="layui-form-item layui-form-text" id="familyAddressParentContent">
																					...
																					<div class="layui-input-block">
																						<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入家庭住址" id="familyAddress" class="layui-input">
																							<p style="color:gray"></p>
																						</div>
																					</div>
																					<div class="layui-form-item layui-form-text" id="parentCelParentContent">
																						...
																						<div class="layui-input-block">
																							<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入家长联系方式" id="parentCel" class="layui-input">
																								<p style="color:gray"></p>
																							</div>
																						</div>
																...
																<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1385"></script>
																<script type="text/javascript">
																	$(function(){
																	$('#majorId').next().remove();
																	...
																	for(var i=0;i<result.length;i++){
																		...
																		for(var i=0;i<result.length;i++){
																			...
																			$.ajax({
																			type: 'post',
																			url: '${pageContext.request.contextPath}/teacher/student_info/add_submit',
																			data:{
																			"stuNo":stuNo,
																			"password":password,
																			"sex":sex,
