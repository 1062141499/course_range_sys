															...
															<div class="layui-form-item" style="text-align:center;">
																<div style="display:inline;width:300px">
																	...
																	<div class="layui-inline" style="margin-top:20px;">
																		<div>
																			<input type="text"  style="display:inline;width:200px" value="" placeholder="请输入学号" id="stuNo" class="layui-input">
																			</div>
																		</div>
																	</div>
																	<div style="display:inline;width:300px">
																		...
																		<div class="layui-inline" style="margin-top:20px;">
																			<div>
																				<input type="text"  style="display:inline;width:200px" value="" placeholder="请输入姓名" id="realName" class="layui-input">
																				</div>
																			</div>
																		</div>
																		<div style="display:inline;width:300px">
																			...
																			<div class="layui-inline" style="margin-top:20px;">
																				<div>
																					<select  id="majorId" style="height:30px;width:200px"  >  <option value="">全部</option>
																		...
																		<div style="display:inline;width:300px">
																			...
																			<div class="layui-inline" style="margin-top:20px;">
																				<div>
																					<select  id="classId" style="height:30px;width:200px"  >  <option value="">全部</option>
																...
																<hr>
																	<div class="layui-form-item">
																		...
																		<span class="l" id="globalBtns">
																			...
																			<a href="javascript:;" onclick="$('#import_data_input').click()" class="layui-btn layui-btn-warm layui-btn-radius">导入学生</a>
																			<a href="${pageContext.request.contextPath}/teacher/student_info/import_data_model" class="layui-btn layui-btn-warm layui-btn-radius" style="background-color:#D4F2E7;color:black">下载导入学生模板</a>
																		...
																		<hr>
																			...
																			<div id="student_info_bar" class="pagination" style="margin-top:20px;"></div>
																		</div>
																	</fieldset>
																	...
																	<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9940"></script>
																	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.css" />
																		<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.js"></script>
	...
	$.ajax({
		...
		success : function(result) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				var familyAddressVal=setNullToEmpty(rows[i].studentInfo.familyAddress);
				html+='<td>'+ familyAddressVal+'</td>';
				var parentCelVal=setNullToEmpty(rows[i].studentInfo.parentCel);
				html+='<td>'+ parentCelVal+'</td>';
