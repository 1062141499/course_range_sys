...
<div class="layui-layout layui-layout-admin">
 ...
 <div class="layui-logo" style="width:300px;"><a  href="#" style="color:white">面向新高考的走班教学管理平台</a></div>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll" style="display:block">
     ...
     <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="我的信息"    data-url="${pageContext.request.contextPath}/teacher/teacher_info/detail">我的信息  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">学生管理 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="学生管理"    data-url="${pageContext.request.contextPath}/teacher/student_info">学生管理  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">空闲时间设置 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="空闲时间设置"    data-url="${pageContext.request.contextPath}/teacher/teacher_time_info">空闲时间设置  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">我的课程 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="我的课程"    data-url="${pageContext.request.contextPath}/teacher/course_info">我的课程  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">课程表查询 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="课程表查询"    data-url="${pageContext.request.contextPath}/teacher/course_range_info">课程表查询  </a>  </dd>
                 <dd>  <a onclick="goPage(this)"  data-name="课表预览"    data-url="${pageContext.request.contextPath}/commonapi/course_show">课表预览  </a>  </dd>
            </dl>
			</li>
			
			<li class="layui-nav-item layui-nav-itemed">
														<a href="javascript:;">调停课 </a>
														<dl class="layui-nav-child">
															<dd>  <a onclick="goPage(this)"  data-name="调停课申请"    data-url="${pageContext.request.contextPath}/teacher/course_apply">调停课申请  </a>  </dd>
														</dl>
														</li>
  ...
  <div class="layui-tabsbody-item layui-show">
					<iframe src="${pageContext.request.contextPath}/teacher/teacher_info/detail" frameborder="0" class="layui-iframe" style="padding: 15px;"></iframe>
				</div>
 </div>
