                ...
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <c:forEach items="${majorInfoList}" var="item">
                        <option value="${item.id}">${item.name}</option>
                            ...
                            <div class="layui-inline">
                            <div class="layui-input-inline" >
                            <select  id="directId" style="height:30px;width:250px;display:inline" >
                            <option value="">全部</option>
                            <c:forEach items="${majorDirectInfoList}" var="item">
                                <option value="${item.id}">${item.name}</option>
                                    ...
                                    <a href="${pageContext.request.contextPath}/teacher/course_info/add" class="layui-btn layui-btn-radius">新增</a>
                                        ...
                                        <div id="course_info_bar" class="pagination" style="margin-top:20px;">
                                        </div>
                                        </div>
                                        </fieldset>
                                            ...
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layuiutil.js"></script>
                                                        ...
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1057"></script>
                                                                ...
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.js?d=124393"></script>
                                                                    ...
                                                                    function ajaxList(page) {
                                                                        ...
                                                                        showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                            $.ajax({
                                                                                type : 'get',
                                                                                url : "${pageContext.request.contextPath}/teacher/course_info/queryList",
                                                                                    data : {
                                                                                        "page":page,
                                                                                    ...
                                                                                    success : function(result) {
                                                                                        ...
                                                                                        for (var i = 0; i < rows.length; i++) {
                                                                            				...
                                                                            				html+='<td>'+isBxVal+'</td>';
                                                                                            html+='<td>';
                                                                                            html+='<a href="${pageContext.request.contextPath}/teacher/course_info/update?id='+rows[i].courseInfo.id+'" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">修改</a>';
                                                                                                html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].courseInfo.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
                                                                                                html+='</td>';
                                                                                                html+='</tr>';
                                                                                            }
                                                                                            if (rows.length == 0) {
                                                                                ...
                                                                                function changeMajorIdVal(){
                                                                                    ...
                                                                                    function del(e){
                                                                                        if(window.confirm('你确定要删除该课程吗')){
                                                                                            ...
                                                                                            $.ajax({
                                                                                                type : 'get',
                                                                                                url : "${pageContext.request.contextPath}/teacher/course_info/del",
                                                                                                    data : {
                                                                                                        "id":id
                                                                                                    },
                                                                                                    success : function(result) {
