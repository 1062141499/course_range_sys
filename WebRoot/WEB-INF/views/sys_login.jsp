...
<title>面向新高考的走班教学管理平台-系统登录</title>
<link rel="shortcut icon" href="${pageContext.request.contextPath}/static/layui/login/img/favicon.ico" type="image/x-icon" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/login/css/login.css">
            ...
            <div class="login layui-anim layui-anim-up" style="width:400px">
            <div class="layui-logo">
            <p style="color:red">${msg}</p>
                </div>
                <fieldset class="layui-elem-field layui-field-title">
                <legend class="text-white">面向新高考的走班教学管理平台</legend>
                </fieldset>
                ...
                <input name="loginType" type="radio" value="2" id="loginType2" style="margin-left:10px;"/><label style="color:white" for="loginType2">教师 </label>
                <input name="loginType" type="radio" value="3" id="loginType3" style="margin-left:10px;"/><label style="color:white" for="loginType3">学生 </label>
