        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/css/global.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/icheck/minimal/red.css">
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <input type="text"  style="width:250px;display:inline"  placeholder="请输入学科方向名进行查询" id="majorName" class="layui-input">
                    </div>
                    </div>
                    ...
                    <a href="${pageContext.request.contextPath}/admin/major_info/add" class="layui-btn layui-btn-radius">新增</a>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1838"></script>
                                            ...
                                            function ajaxList(page) {
                                                ...
                                                showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                    $.ajax({
                                                        type : 'get',
                                                        url : "${pageContext.request.contextPath}/admin/major_info/queryList",
                                                            data : {
                                                                "page":page,
                                                                "majorName":majorName
                                                            ...
                                                            success : function(result) {
                                                                ...
                                                                for (var i = 0; i < rows.length; i++) {
                                                                    html += '<tr>' ;
                                                                    var majorNameVal=setNullToEmpty(rows[i].majorInfo.majorName);
                                                                    html+='<td>'+ majorNameVal+'</td>';
                                                                    html+='<td>';
                                                                    html+='<a href="${pageContext.request.contextPath}/admin/major_info/update?id='+rows[i].majorInfo.id+'" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">修改</a>';
                                                                        html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].majorInfo.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
                                                                        html+='</td>';
                                                                        html+='</tr>';
                                                                    }
                                                                    if (rows.length == 0) {
                                                        ...
                                                        function del(e){
                                                            if(window.confirm('你确定要删除该学科方向吗')){
                                                                ...
                                                                $.ajax({
                                                                    type : 'get',
                                                                    url : "${pageContext.request.contextPath}/admin/major_info/del",
                                                                        data : {
                                                                            "id":id
                                                                        },
                                                                        success : function(result) {
