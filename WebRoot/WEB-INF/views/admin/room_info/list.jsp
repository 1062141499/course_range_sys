        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/css/global.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/icheck/minimal/red.css">
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <input type="text"  style="width:250px;display:inline"  placeholder="请输入教室名进行查询" id="roomName" class="layui-input">
                    </div>
                    </div>
                    ...
                    <a href="${pageContext.request.contextPath}/admin/room_info/add" class="layui-btn layui-btn-radius">新增</a>
                                                        ...
                                                        url : "${pageContext.request.contextPath}/admin/room_info/queryList",
                                                            ...
                                                            success : function(result) {
                                                                ...
                                                                for (var i = 0; i < rows.length; i++) {
                                                                    ...
                                                                    var maxNumVal=setNullToEmpty(rows[i].roomInfo.maxNum);
                                                                    html+='<td>'+ maxNumVal+'</td>';
                                                                    html+='<td>';
                                                                    html+='<a href="${pageContext.request.contextPath}/admin/room_info/update?id='+rows[i].roomInfo.id+'" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">修改</a>';
                                                                        html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].roomInfo.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
                                                                        html+='</td>';
                                                                        html+='</tr>';
                                                                    }
                                                                    if (rows.length == 0) {
