        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/css/global.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/icheck/minimal/red.css">
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <input type="text"  style="width:250px;display:inline"  placeholder="请输入班级名进行查询" id="className" class="layui-input">
                    </div>
                    </div>
                    ...
                    <c:forEach items="${majorInfoList}" var="item">
                        <option value="${item.id}">${item.name}</option>
                            ...
                            <a href="${pageContext.request.contextPath}/admin/class_info/add" class="layui-btn layui-btn-radius">新增</a>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layuiutil.js"></script>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3456"></script>
                                                                        ...
                                                                        url : "${pageContext.request.contextPath}/admin/class_info/queryList",
                                                                            ...
                                                                            success : function(result) {
                                                                                ...
                                                                                for (var i = 0; i < rows.length; i++) {
                                                                                    html += '<tr>' ;
                                                                                    var classNameVal=setNullToEmpty(rows[i].classInfo.className);
                                                                                    html+='<td>'+ classNameVal+'</td>';
                                                                                    var majorIdVal=setNullToEmpty(rows[i].majorIdStr);
                                                                                    html+='<td>'+ majorIdVal+'</td>';
                                                                                    html+='<td>';
                                                                                    html+='<a href="${pageContext.request.contextPath}/admin/class_info/update?id='+rows[i].classInfo.id+'" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">修改</a>';
                                                                                        html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].classInfo.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
                                                                                        html+='</td>';
                                                                                        html+='</tr>';
                                                                                    }
                                                                                    if (rows.length == 0) {
