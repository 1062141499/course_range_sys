							...
							<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
								...
								<link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
									...
									<div class="layui-container" style="overflow:hidden;min-height:850px">
													...
													<div class="layui-field-box">
														<div >
															...
															<div class="layui-form-item layui-form-text" id="weekNoParentContent">
																...
																<div class="layui-input-block">
																	<input type="text"  style="display:inline;width:400px" value="" placeholder="请输入第几周(请输入数字)" id="weekNo" class="layui-input">
																		<p style="color:gray"></p>
																	</div>
																</div>
										...
										<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4148"></script>
										<script type="text/javascript">
											$(function(){
											...
											$.ajax({
											type: 'post',
											url: '${pageContext.request.contextPath}/admin/course_range_info/add_submit',
											data:{
											"courseId":courseId,
											"roomId":roomId,
											"weekNo":weekNo,
