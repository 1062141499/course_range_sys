...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <input type="text"  style="width:500px;display:inline" value="${data.tno}" placeholder="请输入工号" id="tno" class="layui-input">	<span style="color:red">*必填</span>
                                            ...
                                            <input type="text"  style="width:500px;display:inline" value="${data.celPhone}" placeholder="请输入联系电话" id="celPhone" class="layui-input">	<span style="color:red">*必填</span>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2521"></script>
                                                            ...
                                                            function submitData(){
                                                                ...
                                                                $.ajax({
                                                                    type: 'post',
                                                                    url: '${pageContext.request.contextPath}/admin/teacher_info/update_submit',
                                                                        data:{
                                                                            "id":'${data.id}',
                                                                                "tno":tno,
                                                                                "passWord":passWord,
