...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <input type="text"  style="width:500px;display:inline" value="${data.termName}" placeholder="请输入学期名" id="termName" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <input type="text"  style="width:500px;display:inline" value="${data.termIntro}" placeholder="请输入学期说明" id="termIntro" class="layui-input">
                    </div>
                    </div>
                    ...
                    <div class="layui-input-block">
                    <input type="text" class="layui-input Wdate"  readonly="readonly"  style="width:500px;display:inline" value="${data.endTime}"  onFocus="WdatePicker({startDate: '%y-%M-%d' })"  placeholder="请输入学期排课截止时间" id="endTime">	<span style="color:red">*必填</span>
                        ...
                        <div class="layui-input-block">
                        <input type="text"  style="width:500px;display:inline" value="${data.weekNum}" placeholder="请输入周数（请输入数字）" id="weekNum" class="layui-input">	<span style="color:red">*必填</span>
                            ...
                            <input type="text"  style="width:500px;display:inline" value="${data.enterYear}" placeholder="请输入入学年份（请输入数字）" id="enterYear" class="layui-input">	<span style="color:red">*必填</span>
                                ...
                                <c:forEach items="${isSettingList}" var="item">
                                    <c:if test="${item.id==data.isSetting}">
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                                        ...
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/My97DatePicker/4.8/WdatePicker.js"></script>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2936"></script>
                                                                    ...
                                                                    function submitData(){
                                                                        ...
                                                                        $.ajax({
                                                                            type: 'post',
                                                                            url: '${pageContext.request.contextPath}/admin/term_info/update_submit',
                                                                                data:{
                                                                                    "id":'${data.id}',
                                                                                        "termName":termName,
                                                                                        "termIntro":termIntro,
